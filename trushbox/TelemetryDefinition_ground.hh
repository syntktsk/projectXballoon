...
// getter of HK で、温度だけやってもいいかも
  // --- 温度系 ---
  int16_t PivotTemp(){ return PivotTemp_; }
  int16_t StarCameraTemp() { return StarCameraTemp_; }
  int16_t MirrorTemp()     { return MirrorTemp_; }
  int16_t GnssTemp_hk()    { return GnssTemp_hk_; }
  int16_t CulculatorTemp() { return CulculatorTemp_; } 
  int16_t BatteryTemp()    { return BatteryTemp_; }
  int16_t GyroTemp()       { return GyroTemp_; }
  int16_t CmosTemp()       { return CmosTemp_; }
  // --- 電圧系 ---
  int16_t PcVolt()         { return PcVolt_; }
  int16_t StarCameravolt() { return StarCameravolt_; }
  int16_t GnssVolt()       { return GnssVolt_; }
  int16_t GyroVolt()       { return GyroVolt_; }
  int16_t CmosVolt()       { return CmosVolt_; }
  int16_t RouterVolt()     { return RouterVolt_; }
  int16_t HeaterVolt()     { return HeaterVolt_; }
  int16_t Pi_hkVolt()      { return Pi_hkVolt_; }
  int16_t PivotVolt()      { return PivotVolt_; }
  int16_t HubVolt()        { return HubVolt_; }
...
private:
  ...
  int16_t PivotTemp_ ;
  int16_t PivotTemp_;
  int16_t StarCameraTemp_;
  int16_t MirrorTemp_;
  int16_t GnssTemp_hk_;
  int16_t CulculatorTemp_;
  int16_t BatteryTemp_;
  int16_t GyroTemp_;
  int16_t CmosTemp_;
  // --- 電圧系 ---
  int16_t PcVolt_;
  int16_t StarCameravolt_;
  int16_t GnssVolt_;
  int16_t GyroVolt_;
  int16_t CmosVolt_;
  int16_t RouterVolt_;
